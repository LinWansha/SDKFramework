...
namespace SDKFramework.Utils
{
    public class TimerHelper
    {
        ...
        private static string[] datetimePatterns =
        {
            ...
            "dd-MM-yyyy HH:mm:ss", "dd.MM.yyyy HH:mm:ss", "d/M/yyyy h:mm:ss tt", "M/d/yyyy h:mm:ss tt",
            "d.M.yyyy H.mm.ss",
            ...
            "dd.MM.yyyy H:mm:ss", "dd.MM.yy HH:mm:ss", "d. MM. yyyy HH:mm:ss", "dd.MM.yyyy H:mm.ss",
            "dd.MM.yyyy HH:mm:ss",
            "yyyy-MM-dd HH:mm:ss", "dd.MM.yyyy HH:mm:ss", "dd/MM/yyyy hh:mm:ss tt", "dd/MM/yyyy h:mm:ss tt",
            "dd.MM.yyyy HH:mm:ss", "dd.MM.yyyy HH:mm:ss", "yyyy/MM/dd HH:mm:ss", "d.M.yyyy H:mm:ss",
            "dd.M.yyyy HH:mm:ss",
            ...
            "dd-MM-yy HH:mm:ss", "dd-MM-yy HH:mm:ss", "dd-MM-yy HH.mm.ss", "dd-MM-yyyy tt h:mm:ss",
            "dd-MM-yyyy HH:mm:ss",
            ...
            "d/M/yyyy HH:mm:ss", "yyyy-MM-dd HH:mm:ss", "dd.MM.yy HH:mm:ss", "dd-MM-yyyy HH:mm:ss",
            "dd/MM/yyyy h:mm:ss tt",
            "dd/MM/yyyy h:mm:ss tt", "dd/MM/yyyy h:mm:ss tt", "d/M/yyyy h:mm:ss tt", "dd/MM/yyyy h:mm:ss tt",
            "yyyy/M/d tt h:mm:ss", "yyyy-MM-dd HH:mm:ss", "yyyy-M-d H:mm:ss", "dd/MM/yyyy HH:mm:ss",
            "dd.MM.yyyy H:mm:ss",
            "yyyy/MM/dd HH:mm:ss", "dd/MM/yyyy HH:mm:ss", "dd/MM/yyyy hh:mm:ss tt", "d/M/yyyy H:mm:ss",
            "yyyy/M/d H:mm:ss",
            "dd.MM.yyyy HH:mm:ss", "dd/MM/yyyy HH:mm:ss", "dd/MM/yyyy hh:mm:ss tt", "dd-MM-yy HH:mm:ss",
            "dd.MM.yyyy HH:mm:ss", "d/MM/yyyy H:mm:ss", "dd.MM.yyyy HH:mm:ss", "dd/MM/yyyy HH:mm:ss",
            "dd.MM.yyyy HH:mm:ss",
            "dd.MM.yyyy H:mm:ss", "dd-MM-yyyy HH:mm:ss", "d/M/yy h:mm:ss tt", "dd.MM.yyyy HH:mm:ss",
            "d. M. yyyy HH:mm:ss",
            "yyyy-MM-dd HH:mm:ss", "yyyy-MM-dd HH:mm:ss", "dd/MM/yyyy HH:mm:ss", "d/MM/yyyy h:mm:ss tt",
            "yyyy/MM/dd HH:mm:ss", "dd-MM-yy HH.mm.ss", "dd-MM-yy h.mm.ss tt", "d-M-yyyy h:mm:ss tt",
            "yyyy-MM-dd HH:mm:ss",
            ...
            "d/MM/yyyy h:mm:ss tt", "dd.MM.yyyy HH:mm:ss", "dd.MM.yyyy. HH:mm:ss", "dd-MM-yyyy H:mm:ss",
            "d/M/yyyy H:mm:ss",
        ...
        public static DateTime ParseToDateTime(string s)
        {
            ...
            if (DateTime.TryParseExact(s, datetimePatterns, CultureInfo.InvariantCulture,
        ...
        {
            //同上
            return DateTime.UtcNow.AddSeconds(-seconds).ToUniversalTime().ToString("yyyy-MM-ddTHH:mm:ss.fffZ");
