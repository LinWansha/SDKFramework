...
public class UniWebView: MonoBehaviour {
    ...
    [Obsolete("Use Toolbar is deprecated. Use the embedded toolbar instead.", false)]
    [SerializeField]
    public UniWebViewToolbarPosition toolbarPosition;

    [SerializeField]
    public bool useEmbeddedToolbar;
    
    [SerializeField]
    public UniWebViewToolbarPosition embeddedToolbarPosition;
    ...
    public bool Show(bool fade = true, UniWebViewTransitionEdge edge = UniWebViewTransitionEdge.Bottom, 
                float duration = 0.4f, Action completionHandler = null) 
    {
        return _Show(fade, edge, duration, false, completionHandler);
    }

    public bool _Show(bool fade = true, UniWebViewTransitionEdge edge = UniWebViewTransitionEdge.Bottom, 
